                ...
                <div class="row my-2">
                    <div class="col-md-4">
                        <div className={`card card_three text-center ${admindashboardstyles.card}`}>
                            ...
                            <a onClick={props.PassMethod} id="ARf">Total Requested Food</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div className={`card card_three text-center ${admindashboardstyles.card}`}>
                            ...
                            <a onClick={props.PassMethod} id="ARc">Total Requested Cloth</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div className={`card card_three text-center ${admindashboardstyles.card}`}>
                            ...
                            <a onClick={props.PassMethod} id="ARv">Total Requested Vessel</a>
                        </div>
                    </div>
                </div>
        </div></>
