                ...
                <div class="row my-2">
                    <div class="col-md-4">
                        <div className={`card card_three text-center ${admindashboardstyles.card}`}>
                            ...
                            <a onClick={props.PassMethod} id="Df">Pending Donated Food</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div className={`card card_three text-center ${admindashboardstyles.card}`}>
                            ...
                            <a onClick={props.PassMethod} id="Dc">Pending Donated Cloth</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div className={`card card_three text-center ${admindashboardstyles.card}`}>
                            ...
                            <a onClick={props.PassMethod} id="Dv">Pending Donated Vessel</a>
                        </div>
                    </div>
                </div>
                <div class="row my-2">
